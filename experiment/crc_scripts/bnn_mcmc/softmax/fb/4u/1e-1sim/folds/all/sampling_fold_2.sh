...
SRC_PATH="/afs/crc.nd.edu/group/cvrl/scratch_21/dprijate/results/debug/bnn_softmax/fb/4u_1e-1/folds/all/fold_2"
...
python3 $BASE_PATH/experiment/research/bnn/proto_bnn_mcmc.py \
    "$HOME/scratch_21/under_over/fb_fq_16b_under_over/fb_full_trained/folds/proto_bnn_format_all_fold_2_train.json" \
    --output_dir "$SRC_PATH/sampling/hmc_4u_1e-1sim_3nlfs_0lag_1e6res/0.0027ss/2e7burn/s2e4/job_$SGE_TASK_ID" \
    --bnn_weights_file "$SRC_PATH/converging/hmc_4u_1e-1sim_3nlfs_0lag_1e6res/0.0027ss/2e7burn/_2020-06-06_07-38-47/last_weights.json" \
    --num_hidden 4 \
    --cpu 1 \
    --cpu_cores 4 \
    --gpu 0 \
